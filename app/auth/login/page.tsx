      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/20 via-primary/10 to-background items-center justify-center p-12">
        <div className="max-w-md space-y-8">
          ...
          <p className="text-lg text-muted-foreground text-pretty">
            Organize your studies, track your progress, and get personalized AI recommendations to help you succeed.
          </p>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Sparkles className="h-4 w-4 text-primary" />
            <span>Powered by advanced AI to optimize your learning</span>
          </div>
        </div>
      </div>
